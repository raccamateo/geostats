...
El objetivo del semivariograma es mostrar que a partir de cierto valor de distancia el estimador de variación no varía más o o que varía pero no en función de la distancia entre pares de puntos. El valor de variación máxima se llama **meseta** o **sill (C1)**.
